...
//			}
	...
	function addModuleTree(module,parentModuleLabelId){
		...
		if(children && children.length > 0){
			moduleHTML += "<img src='"+staticResourcesRootPath+"/images/other/箭头_右.png' alt='' class='img_right' style='float: right; margin-right: 18px;' />";
			moduleA.innerHTML = moduleHTML;
...
//			moduleLi.setAttribute("onclick", "creat(this,'"+moduleChildrenUlId+"','name1','45px')");
	...
	function addModuleChildren(children,parentModuleLi){
		...
		parentModuleLiUlHTMLFirstChildHTML += "<img src='"+staticResourcesRootPath+"/images/other/箭头_右.png' alt='' class='img_right' style='float: right; margin-right: 18px;' />";
